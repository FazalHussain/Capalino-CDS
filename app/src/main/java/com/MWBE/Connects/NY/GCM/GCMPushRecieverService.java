...
public class GCMPushRecieverService extends GcmListenerService {
    ...
    private void sendNotificationEvent(String message, String direction, String title) {
        Intent intent = null;


        if(direction.equalsIgnoreCase("Event")) {
    ...
    private void sendNotificationAlert(String message, String direction, String title) {
    ...
    private void sendNotificationAnnouncement(String message, String direction, String title) {
        Intent intent = null;
        if(direction.equalsIgnoreCase("Announcement")){
    ...
    private void sendNotification(String msg) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        //.setSmallIcon(R.mipmap.icon)
                        .setContentTitle("MWBE Notification")
                        //.setSubText(ticker)
