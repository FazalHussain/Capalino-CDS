 ...
 */
public class ItemListAdapterGeographicFragment extends ArrayAdapter<ListData_Agency> {
     ...
     */
    public ItemListAdapterGeographicFragment(Context context, List<ListData_Agency> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if(Storage.list_check.size()>0)
                    if(Storage.list_check.get(position)){
