...
public class AnetIntentService extends IntentService {
    ...
    private void authenticateUser(ResultReceiver receiver, Intent intent) {
        ...
        try {
            ...
            //String deviceId = "358347040811237";
            String deviceId = Settings.Secure.getString(this.getContentResolver(),
                    Settings.Secure.ANDROID_ID);
            String deviceDescription = "";
            String deviceTelephoneNumber = "+923322443410";
    ...
    private void makeTransaction(ResultReceiver receiver, Intent intent) {
        ...
        try {
            ...
            AnetSingleton.merchant.setMarketType(MarketType.ECOMMERCE);
            ...
            //transaction.setEmailReceipt(emailReceipt);
    ...
    public Order createOrder(BigDecimal totalAmount) {
        ...
        testItem.setItemId("CapalinoSubscriptionID");
        testItem.setItemName("CapalinoSubscription");
    ...
    public Customer createCustomer(String zipcode) {
        ...
        billingAddress.setFirstName(StaticData.fname);
        billingAddress.setLastName(StaticData.lname);
        billingAddress.setAddress(StaticData.Address);
        billingAddress.setCity(StaticData.city);
        billingAddress.setCountry("USA");
        billingAddress.setState(StaticData.state);
        billingAddress.setAddressId(StaticData.email);
